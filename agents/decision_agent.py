...
AGENT_SYSTEM_PROMPT = (
    ...
    "location), not English, and pure SWE with NO AI/LLM/ML/data/automation "
    "component. That last one is narrow on purpose: a role that BUILDS, "
    "INTEGRATES or OPERATES AI systems is ON target even when its title reads "
    "Software Engineer, Backend Engineer, Full-Stack Engineer, Product "
    "Engineer, Forward Deployed Engineer or Internal Tools Engineer. Skip only "
    "the role with no AI, ML, LLM, data or automation content at all. "
    "Also always auto-SKIP -- score below the "
